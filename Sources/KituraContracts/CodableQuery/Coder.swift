...
/**
 Class defining shared resources for the [QueryDecoder](https://github.com/Kitura-Next/KituraContracts/blob/master/Sources/KituraContracts/CodableQuery/QueryDecoder.swift) and [QueryEncoder](https://github.com/Kitura-Next/KituraContracts/blob/master/Sources/KituraContracts/CodableQuery/QueryEncoder.swift).
